...
execute @e[tag=gameMaster,score_gameType_min=1,score_gameType=1,score_helperOperation_min=-1,score_players_min=3] ~ ~ ~ execute @a[tag=needTeleport] ~ ~ ~ tellraw @a [{"text":""},{"text":"!","bold":"true","color":"yellow"},{"text":"» ","color":"dark_gray"},{"selector":"@s","bold":"true"},{"text":"さんがステージをクリアしました！"},{"text":" (","color":"gray"},{"score":{"name":"@e[tag=gameMaster]","objective":"totalHelpers"},"color":"gray"},{"text":"/","color":"gray"},{"score":{"name":"@e[tag=gameMaster]","objective":"totalOperation"},"color":"gray"},{"text":")","color":"gray"}]
execute @e[tag=gameMaster,score_gameType_min=1,score_gameType=1,score_helperOperation_min=-1,score_players_min=1,score_players=2] ~ ~ ~ execute @a[tag=needTeleport] ~ ~ ~ tellraw @a [{"text":""},{"text":"!","bold":"true","color":"yellow"},{"text":"» ","color":"dark_gray"},{"selector":"@s","bold":"true"},{"text":"さんがステージをクリアしました！"}]
execute @e[tag=gameMaster,score_gameType_min=1,score_gameType=1,score_helperOperation_min=-1] ~ ~ ~ effect @a[tag=needTeleport] regeneration 1 250 true
